...
<img width=260 src="../images/image006.png"/>  
<img width=260 src="../images/image007.png"/>  
<img width=240 src="../images/image008.png"/>  
<img width=240 src="../images/image008.png"/>  

## Forward Kinematics of a Leg

With the *DH* transformation matrixes at hand, computation of the leg’s pose out of the joint angles is straight forward. The matrix representing the toe’s pose <img width="20" src="../images/image010.png"/> is 

&nbsp;&nbsp;&nbsp;&nbsp;<img width="150" src="../images/image011.png"/> 
...
&nbsp;&nbsp;&nbsp;&nbsp;<img width="400" src="../images/image013.png"/>

We get 

&nbsp;&nbsp;&nbsp;&nbsp;<img width="200" src="../images/image014.png"/>

Later on, we will need the coordinates of end of the first limb (*A*) which is <img width=100 src="../images/image015.png"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<img width=300 src="../images/image016.png"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<img width=150 src="../images/image019.png"/>

&nbsp;&nbsp;&nbsp;&nbsp;<img width=150 src="../images/image020.png"/>

&nbsp;&nbsp;&nbsp;&nbsp;<img width=100 src="../images/image021.png"/>

Now that the triangle is defined, we can compute the height <img width=10 src="../images/image022.png"/> by Herons formula

&nbsp;&nbsp;&nbsp;&nbsp;<img width=300 src="../images/image023.png"/>

The base of the height *H* is defined by 

&nbsp;&nbsp;&nbsp;&nbsp;<img width=90 src="../images/image024.png"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<img width=90 src="../images/image027.png"/>

So, with the arbitrary assumption <img width=5 src="../images/image028.png"/> and the length <img width=6 src="../images/image029.png"/> we get 

&nbsp;&nbsp;&nbsp;&nbsp;<img width=220 src="../images/image030.png"/>
...
There are two possibilities for *S*, representing two configuration with knee up and knee down. We always take the healthy one where the knee is above the toe point. Finally, T is defined by its orthogonality to *S* and its length <img width=6 src="../images/image031.png"/>:
...
&nbsp;&nbsp;&nbsp;&nbsp;<img width=800 src="../images/image037.png"/>
